...
rel_abund_rarefied_mh <- subset_samples(rel_abund_rarefied, location == "Mount Hood")
rel_abund_rarefied_gnp <- subset_samples(rel_abund_rarefied, location == "Glacier National Park")
...
rel_abund_bubble_1 <- psmelt(ps_order_trim)
